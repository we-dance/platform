...
5. Transform firebaseConfig value (JS object) to one line JSON, for this paste value of `firebaseConfig` (from step 2). [This tool](https://www.convertjson.com/javascript-object-to-json.htm) might help you.
