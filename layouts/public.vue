    ...
    <TFooter>
      <div class="flex items-center justify-between flex-wrap mb-8">
        <div class="flex items-center justify-start">
          <NuxtLink :to="localePath('/')" class="flex items-center pb-2">
        ...
        <div class="flex space-x-2">
          <TButton type="link" :to="localePath('/events')"
            >Event Calendar</TButton
          >
          <TButton type="link" :to="localePath('/community')"
            >Find a partner</TButton
          >
          <TButton type="link" :to="localePath('/feed')">Dance News</TButton>
        </div>
      </div>
    </TFooter>
  </div>
